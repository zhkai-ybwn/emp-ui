...
const System: AppRouteRecordRaw = {
  ...
  children: [
    ...
    },
    {
      ...
      component: () => import('@/views/system/equipment/type/index.vue'),
      meta: {
        requiresAuth: true,
      },
    },
    {
      ...
      component: () => import('@/views/system/equipment/info/index.vue'),
      meta: {
        requiresAuth: true,
      },
    },
    {
      name: 'Space',
      path: '/system/space',
      component: () => import('@/views/system/space/index.vue'),
      meta: {
        requiresAuth: true,
      },
    },
