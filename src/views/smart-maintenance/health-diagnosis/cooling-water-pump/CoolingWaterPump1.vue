 ...
 * @Date: 2024-01-08 13:21:58
 * @LastEditors: zhangk 13182353591@163.com
 * @LastEditTime: 2024-03-25 09:29:35
 * @FilePath: \emp-admin-ui\src\views\smart-maintenance\health-diagnosis\cooling-water-pump\CoolingWaterPump1.vue
 * @Description: 冷却水泵#1
 * 
...
<template>
  <div class="chilled-water-pump">
    <Breadcrumb class="bread" :items="['智慧运维', '健康诊断', '冷却水泵#1']" />
      ...
      <div class="alarm-list">
        ...
        >
          ...
          <div class="point-value">
            {{ item.pointId !== '251631024953365102' ? item.pointValue : ''
            }}<span>{{ item.unit }}</span>
          </div>
          <div
            v-if="!item.pointDisplayName.includes('时间')"
            :class="['alarm-level', getLevelClass(item)]"
            >{{ item.alarmLevel ? item.alarmLevel : '正常' }}</div
          >
          <div v-if="item.alarmLevel" class="view" @click="goRealtime"
            >查看</div
          >
        </div>
      </div>
...
<script setup lang="ts">
  ...
  import CoolWaterTransmissionChart from './components/CoolWaterTransmissionChart.vue';
      ...
      .m-box {
        ...
        .model-box {
          ...
          .model {
            ...
            .set-back('@/assets/imgs/smart/health/chilled-water-pump-model.png');
          }
        }
      }
