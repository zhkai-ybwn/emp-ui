 ...
 * @Date: 2024-01-08 13:22:05
 * @LastEditors: zhangk 13182353591@163.com
 * @LastEditTime: 2024-03-25 09:30:22
 * @FilePath: \emp-admin-ui\src\views\smart-maintenance\health-diagnosis\cooling-water-pump\CoolingWaterPump2.vue
 * @Description: 冷却水泵#2
 * 
...
<template>
  <div class="chilled-water-pump">
    <Breadcrumb class="bread" :items="['智慧运维', '健康诊断', '冷却水泵#2']" />
      ...
      <div class="alarm-list">
        ...
        >
          ...
          <div class="point-value">
            {{ item.pointId !== '251631049012941425' ? item.pointValue : ''
            }}<span>{{ item.unit }}</span>
          </div>
          <div
