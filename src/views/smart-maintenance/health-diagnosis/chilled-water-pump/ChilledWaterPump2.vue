 ...
 * @Date: 2024-01-08 13:21:30
 * @LastEditors: zhangk 13182353591@163.com
 * @LastEditTime: 2024-04-09 10:33:31
 * @FilePath: \emp-admin-ui\src\views\smart-maintenance\health-diagnosis\chilled-water-pump\ChilledWaterPump2.vue
 * @Description: 冷水泵#2
 * 
...
<template>
  <div class="chilled-water-pump">
    <Breadcrumb class="bread" :items="['智慧运维', '健康诊断', '冷水泵#2']" />
      ...
      <div class="alarm-list">
        ...
        >
          ...
          <div class="point-value">
            {{ item.pointId !== '251630998736867948' ? item.pointValue : ''
            }}<span>{{ item.unit }}</span>
          </div>
          <div
