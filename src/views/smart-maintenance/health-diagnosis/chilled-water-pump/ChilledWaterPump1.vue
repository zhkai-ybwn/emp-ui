 ...
 * @Date: 2024-01-08 13:21:22
 * @LastEditors: zhangk 13182353591@163.com
 * @LastEditTime: 2024-02-22 10:19:53
 * @FilePath: \emp-admin-ui\src\views\smart-maintenance\health-diagnosis\chilled-water-pump\ChilledWaterPump1.vue
 * @Description: 冷水泵#1
 * 
...
<template>
  <div class="chilled-water-pump">
    <Breadcrumb class="bread" :items="['智慧运维', '健康诊断', '冷水泵']" />
      ...
      <div class="alarm-list">
        ...
        >
          ...
          <div class="point-value">
            {{ item.pointId !== '251630977097405033' ? item.pointValue : ''
            }}<span>{{ item.unit }}</span>
          </div>
          <div
