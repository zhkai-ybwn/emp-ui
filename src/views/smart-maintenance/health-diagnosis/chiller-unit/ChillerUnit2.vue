...
<template>
  <div class="chiller-unit1">
    <Breadcrumb :items="['智慧运维', '健康诊断', '冷水机组#2']" />
    <div class="section">
      <LengShuiJiZu2 style="margin-right: 24px" :data="state.partPointDetail" />
...
<script lang="ts" setup>
  ...
  import LengShuiJiZu2 from './components/LengShuiJiZu2.vue';
