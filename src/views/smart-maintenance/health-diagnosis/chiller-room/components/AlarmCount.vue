 ...
 * @Date: 2024-01-11 14:08:16
 * @LastEditors: zhangk 13182353591@163.com
 * @LastEditTime: 2024-02-05 14:37:46
 * @FilePath: \emp-admin-ui\src\views\smart-maintenance\health-diagnosis\chiller-room\components\AlarmCount.vue
 * @Description: 报警统计
 * 
...
<template>
  <div class="alarm-count">
    ...
    <div class="op-box">
      ...
      >
        <div class="item-name">{{ item.pointDisplayName }}</div>
...
<script setup lang="ts">
  ...
  const fetchData = async (
    params: DeviceAlarmReq = {
      ...
      pointTypes: ['INSTANT_COP', 'AVG_COP', 'INSTANT_SCOP', 'AVG_SCOP'],
      timeType: 0,
    }
  ) => {
    try {
