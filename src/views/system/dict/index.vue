    ...
    <a-card class="general-card" :title="$t('menu.system.dict.list')">
      ...
      >
        <a-form ref="formRef" :model="form" :rules="rules" size="large">
          <a-form-item label="字典类型" field="category">
            <a-input
              v-model="form.category"
              placeholder="请输入字典类型"
              :disabled="form.bdefault"
            />
          </a-form-item>
          <a-form-item label="类型名称" field="categoryName">
            <a-input v-model="form.categoryName" placeholder="请输入字典名称" />
          </a-form-item>
          ...
          <a-form-item label="字典值" field="dictValue">
