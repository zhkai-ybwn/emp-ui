          ...
          <div class="header">
            ...
            <div v-show="showQuery" class="header-query">
              <a-form ref="queryRef" :model="queryParams" layout="inline">
                ...
                <a-form-item v-if="false" field="createTime" hide-label>
...
<script lang="ts" setup>
      ...
      username: [
        {
          required: true,
          message:
            '用户名长度为 4 到 64 位，可以包含字母、数字，下划线，以字母开头',
          match: /^[a-zA-Z][a-zA-Z0-9_]{3,64}$/,
        },
      ],
      nickname: [
        {
          required: true,
          message:
            '昵称长度为 2 到 30 位，可以包含中文、字母、数字、下划线，短横线',
  ...
  const getDeptOptions = () => {
    ...
    listDeptTree({ sort: ['parentId,asc', 'sort,asc', 'createTime,desc'] })
      .then((res) => {
