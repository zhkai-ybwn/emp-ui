...
export function queryDataChainGrowth(data: DataChainGrowth) {
  return axios.post<DataChainGrowthRes>(
    '/emp-admin/api/data-chain-growth',
    data
  );
}
...
export function queryPopularAuthor() {
  return axios.get<PopularAuthorRes>('/emp-admin/api/popular-author/list');
}
...
export function queryContentPublish() {
  return axios.get<ContentPublishRecord[]>('/emp-admin/api/content-publish');
}

export function queryContentPeriodAnalysis() {
  return axios.get<GeneralChart>('/emp-admin/api/content-period-analysis');
}
...
export function queryPublicOpinionAnalysis(data: DataChainGrowth) {
  return axios.post<PublicOpinionAnalysisRes>(
    '/emp-admin/api/public-opinion-analysis',
    data
  );
}
...
export function queryDataOverview() {
  return axios.get<DataOverviewRes>('/emp-admin/api/data-overview');
}
