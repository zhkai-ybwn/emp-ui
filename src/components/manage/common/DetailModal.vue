 ...
 * @LastEditTime: 2024-04-07 15:58:57
 * @FilePath: \emp-admin-ui\src\components\manage\common\DetailModal.vue
 * @Description: 报警详情 
 * 
...
<script setup>
  ...
  import { getRealAlarmDetail } from '@/api/alarm';
  ...
  const getData = async () => {
    ...
    try {
      const res = await getRealAlarmDetail(getParam());
